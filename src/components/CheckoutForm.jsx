...
const CheckoutForm = () => {
    return (
        <div className='py-[10px] w-100 d-block'>
            ...
            <div className="row gx-3">
                ...
                <div className="col-md-6">
                    <div className="form-group">
                        <TextInput type='text' id="first-name" placeholder="First name (optional)" />
                        {/* <input type="text"  className="form-control checkout"  /> */}
                    </div>
                </div>
                <div className="col-md-6">
                    <div className="form-group">
                        <TextInput type="text" id="last-name" className="form-control checkout" placeholder="Last name" />

                    </div>
                </div>
                <div className="col-md-12">
                    <div className="form-group">
                        <TextInput type="text" id="address" placeholder="Address" />
                    </div>
                </div>
                <div className="col-md-12">
                    <div className="form-group">
                        <TextInput type="text" id="apartment" placeholder="Apartment, suite, etc. (optional)" />

                    </div>
                </div>
                <div className="col-md-4">
                    <div className="form-group">
                        <TextInput type="text" id="city" className="form-control checkout" placeholder="City"  />
                    </div>
                </div>
                <div className="col-md-4">
                    <div className="form-group">
